...
total = int(input("How many student on the course? "))
size = int(input("Desired group size? "))
has_remainder = 0 if total % size == 0 else 1  # 1 if has remainder, otherwise 0

print(f"Number of groups formed: {total // size + has_remainder}")
